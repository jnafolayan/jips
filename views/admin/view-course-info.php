...
<div class="wrapper">
  ...
  <div id="course-info" class="row">
    <div class="mb-3 col-md-12">
      ...
      <input type="text" class="form-control" id="course-code" name="course-code" value="<?php echo $course["code"] ?>" disabled readonly>
    </div>

    <div class="mb-3 col-md-12">
      <label for="course-title" class="form-label">Course Title</label>
      <input type="text" class="form-control" id="course-title" name="course-title" value="<?php echo $course["title"] ?>" disabled readonly>
    </div>

    <div class="mb-3 col-md-12">
      <label for="assigned-lecturer" class="form-label">Assigned Lecturers</label>
      <input type="text" class="form-control" id="assigned-lecturer" name="assigned-lecturer" value="<?php echo implode(", ", $lecturerNames) ?>" disabled readonly>
    </div>
